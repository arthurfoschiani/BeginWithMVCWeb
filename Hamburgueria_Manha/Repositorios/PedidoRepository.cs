...
namespace Hamburgueria.Repositories
{
    public class PedidoRepository : BaseRepository
    {
        ...
        private string PrepararRegistroCSV(Pedido pedido)
        {
            ...
            return $"id={id};clienteNome={pedido.Cliente.Nome};clienteEndereco={pedido.Cliente.Endereco};clienteTelefone={pedido.Cliente.Telefone};clienteEmail={pedido.Cliente.Email};hamburguerNome={pedido.Hamburguer.Nome};hamburguerPreco={pedido.Hamburguer.Preco};shakeNome={pedido.Shake.Nome};shakePreco={pedido.Shake.Preco};dataPedido={pedido.DataPedido};precoTotal={pedido.PrecoTotal}\n";
        }
    }
}